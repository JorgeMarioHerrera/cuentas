...
public class Factory {
    ...
    public static OAuthRequestFUA getRequestFUA(){
        return OAuthRequestFUA.builder()
                .code("12345")
                .build();
    }
    ...
    public  static ResponseSuccessFUA getResponseSuccessFUA(String documentType){
        return ResponseSuccessFUA.builder()
                .documentType(documentType)
                .documentNumber("5454012008")
                .customerName("PRUEBA DIRECCIONES ETAPA DOS")
                .lastEntryDate("2017/05/15")
                .lastHour("09:44:07")
                .tokenType("Bearer")
                .sessionToken("9a5s5ffg2r23r31tr4y")
                .build();
    }
    ...
    public static UserTransactional getUserTransactionalValid(){
        return  UserTransactional.builder()
                ...
                .hasSoftToken(true)
                .homeDelivery(true)
                .softTokenLastUpdate("2021-09-24")
                .dynamicMechanism("STK")
                .savingBalance(0.00)
                .currentBalance(0.00)
                .fundsBalance(0.00)
                .availableOverdraft(0.00)
                .attemptsManagement(0)
                .attemptsReadyData(0)
    ...
    public static UserTransactional getUserTransactionalConcurrent(){
        return  UserTransactional.builder()
                .validSession(true)
                .device("Macbook Pro 13 inch")
                .docNumber("5454012008")
