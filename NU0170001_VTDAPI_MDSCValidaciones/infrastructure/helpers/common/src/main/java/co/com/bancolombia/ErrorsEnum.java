...
public enum ErrorsEnum {
    ...
    CD_ILLEGAL_ARGUMENT_EXCEPTION("VALDACD-006",
    ...
    CB_ILLEGAL_STATE("VALDACB-001", "El entorno Java o la aplicación Java no" +
            " se encuentran en un estado apropiado para la operación solicitada."),
    CB_JSON_PROCESSING("VALDACB-002", "problemas encontrados al procesar  JSON de Consolidated Balance."),
    CB_IO_EXCEPTION("VALDACB-003", "- si la solicitud no se pudo ejecutar debido a" +
            " la cancelación, un problema de conectividad o el tiempo de espera en Consolidated Balance"),
    CB_ILLEGAL_ARGUMENT_EXCEPTION("VALDACB-004", "Argumento inapropiado en el json de respuesta de" +
            " Consolidated Balance"),
    CB_ERR_UNKNOWN("VALDACB-UNKNOWN", "Error desconocido en el servicio de Consolidated Balance"),

    // CONSOLIDATED BALANCE SERVICE VALUES
    FA_ILLEGAL_STATE("VALDAFA-001", "El entorno Java o la aplicación Java no" +
            " se encuentran en un estado apropiado para la operación solicitada."),
    FA_JSON_PROCESSING("VALDAFA-002", "problemas encontrados al procesar  JSON de Funds Administration"),
    FA_IO_EXCEPTION("VALDAFA-003", "- si la solicitud no se pudo ejecutar debido a" +
            " la cancelación, un problema de conectividad o el tiempo de espera en Funds Administration"),
    FA_ILLEGAL_ARGUMENT_EXCEPTION("VALDAFA-004", "Argumento inapropiado en el json de respuesta " +
            "de Funds Administration"),
    FA_ERR_UNKNOWN("VALDAFA-UNKNOWN", "Error desconocido en el servicio de Funds Administration"),


    // ACCCOUNT BALANCE SERVICE VALUES
    AB_ILLEGAL_STATE("VALDAAB-001", "El entorno Java o la aplicación Java no" +
            " se encuentran en un estado apropiado para la operación solicitada."),
    AB_JSON_PROCESSING("VALDAAB-002", "problemas encontrados al procesar  JSON de Account balance."),
    AB_IO_EXCEPTION("VALDAAB-003", "- si la solicitud no se pudo ejecutar debido a" +
            " la cancelación, un problema de conectividad o el tiempo de espera en Account balance"),
    AB_ILLEGAL_ARGUMENT_EXCEPTION("VALDAAB-004", "Argumento inapropiado en el json de respuesta de Account balance"),
    AB_ERR_UNKNOWN("VALDAAB-UNKNOWN", "Error desconocido en el servicio de Account balance "),

    // BANNER SERVICE VALUES
    BAN_ILLEGAL_STATE("VALDABAN-001", "El entorno Java o la aplicación Java no" +
            " se encuentran en un estado apropiado para la operación solicitada."),
    BAN_JSON_PROCESSING("VALDABAN-002", "problemas encontrados al procesar  JSON de banner service."),
    BAN_IO_EXCEPTION("VALDABAN-003", "- si la solicitud no se pudo ejecutar debido a" +
            " la cancelación, un problema de conectividad o el tiempo de espera en banner service"),
    BAN_ILLEGAL_ARGUMENT_EXCEPTION("VALDABAN-004", "Argumento inapropiado en el json de respuesta de banner service"),
    BAN_ERR_UNKNOWN("VALDABAN-UNKNOWN", "Error desconocido en el servicio de banner service "),
