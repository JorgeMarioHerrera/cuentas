...
public class Constants {
    ...
    public static final String COMMON_HEADER_MESSAGE_ID_FUA = "messageid";
    ...
    public static final Integer COMMON_NUMBER_THIRTYFIVE = 35;
    ...
    public static final String DOCUMENT_TYPE_CC = "FS001";
    ...
    public static final int AL_FILTER_RELATION_SIZE= 20;
    public static final int AL_FILTER_RELATION_KEY= 1;

    //Account Balance
    public static final String PREFIX_ACCOUNT_BALANCE_ERROR = "AB-";

    //Account Balance
    public static final String PREFIX_BANNER_ERROR = "BAN-";

    //Account List
    public static final String PREFIX_CONSOLIDATED_BALANCE_ERROR = "CB-";
