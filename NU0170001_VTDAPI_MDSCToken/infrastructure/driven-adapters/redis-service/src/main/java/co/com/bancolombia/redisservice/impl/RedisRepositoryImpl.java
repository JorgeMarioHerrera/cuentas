...
public class RedisRepositoryImpl implements IRedis {
    ...
    public Either<ErrorExeption, Boolean> saveUser(UserTransactional user) {
        ...
        try {
            validateObject(user);
            loggerApp.init(this.getClass().toString(), LoggerOptions.Services.TM_DRIVEN_ADAPTER_REDIS,
                    user.getSessionID());
    ...
    public Either<ErrorExeption, List<UserTransactional>> getSessionsConcurrent(String docNumber,
        ...
        try {
            ...
            loggerApp.init(this.getClass().toString(), LoggerOptions.Services.TM_DRIVEN_ADAPTER_REDIS, idSession);
